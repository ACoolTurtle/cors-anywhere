declare module "cors-anywhere" {
  ...
  export function createServer(
    options?: Partial<{
       ...
       * `https_proxy`, `no_proxy`, etc.). // object
       */
      getProxyForUrl: (url: string | Record<string, unknown>) => string
